...
# Fonts
OPEN_SANS = resource_path("assets/fonts/OpenSans-Regular.ttf")
...
# Add images
flag = pygame.image.load(resource_path("assets/images/flag.png"))
flag = pygame.transform.scale(flag, (cell_size, cell_size))
mine = pygame.image.load(resource_path("assets/images/mine.png"))
...
while True:
    ...
    bText = "AutoWin" if not autowin else "Stop"
